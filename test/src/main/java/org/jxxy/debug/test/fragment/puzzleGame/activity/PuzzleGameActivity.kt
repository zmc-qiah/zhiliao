...
import org.jxxy.debug.test.databinding.ActivityGameSecondBinding
import java.io.File
...
class PuzzleGameActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityGameSecondBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityGameSecondBinding.inflate(layoutInflater)
