...
import org.jxxy.debug.test.databinding.ActivityPuzzlesBinding
...
class PuzzlesActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val url =
            "https://bucket-lsp.oss-cn-hangzhou.aliyuncs.com/2023/08/31/1a4823a3-73cc-46e8-8569-a49b7caa9e8b.jpg"
        binding.backgroundIv.load("https://bucket-lsp.oss-cn-hangzhou.aliyuncs.com/2023/09/01/a27305a6-003e-4fc6-9024-c08242852346.jpg")
        binding.frameIv.load("https://bucket-lsp.oss-cn-hangzhou.aliyuncs.com/2023/09/01/9d162368-2f5c-4ad0-a960-95b8ef2e9a64.jpg")
        val intent = intent
...
//        imageView.load("https://tse3-mm.cn.bing.net/th/id/OIP-C.yuFuc0WdjMSeu6CgGYyljwHaEK?pid=ImgDet&rs=1")
