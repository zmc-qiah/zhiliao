...
import org.jxxy.debug.corekit.widget.help.RoundHelper
import org.jxxy.debug.corekit.widget.help.RoundMethodInterface

class RoundImageView@JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0
) : androidx.appcompat.widget.AppCompatImageView(context, attrs, defStyleAttr), RoundMethodInterface {
