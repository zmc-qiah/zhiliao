...
import org.jxxy.debug.theme.posemon.data.BodyPart
import org.jxxy.debug.theme.posemon.data.Device
import org.jxxy.debug.theme.posemon.data.KeyPoint
import org.jxxy.debug.theme.posemon.data.Person
import org.jxxy.debug.theme.posemon.data.TorsoAndBodyDistance
...
class MoveNet(private val interpreter: Interpreter, private var gpuDelegate: GpuDelegate?) :
    ...
    companion object {
        ...
        /** 设置 movenet 版本，movenet_thunder_fp16.tflite 只能在 CPU、GPU 上运行，
