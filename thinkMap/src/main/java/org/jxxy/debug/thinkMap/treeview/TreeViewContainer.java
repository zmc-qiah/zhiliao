...
import org.jxxy.debug.thinkMap.treeview.cache_pool.HolderPool;
import org.jxxy.debug.thinkMap.treeview.cache_pool.PointPool;
...
import org.jxxy.debug.thinkMap.treeview.touch.DragBlock;
...
//        }
    ...
    */
            ...
            if(getHit){
                ...
                if(releasedChildHolderNode.getParentNode()!=null){
                    if (dragListener != null){
                        dragListener.removeNode(releasedChildHolderNode.getParentNode(),releasedChildHolderNode,targetHolderNode);
                    }
    ...
    private void innerRemoveNode(NodeModel<?> nodeModel, boolean isRemoveChildNodesOnly){
        if(adapter!=null){
            if(isAnimateRemove()){
                Log.d(TAG, "innerRemoveNode: aaaa");
